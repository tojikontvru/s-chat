...
public class CallCoordinator implements DcEventCenter.DcEventDelegate {
  ...
  private void createNotificationChannels() {
    ...
    incomingChannel.setDescription("Notifications for incoming S Chat calls");
    ...
    ongoingChannel.setDescription("Notifications for active S Chat calls");
    ...
    missedChannel.setDescription("Notifications for missed S Chat calls");
